...
# QUERY LISTS-----------------------------------------------------------------------------------------------------------
create_table_queries = [user_table_create, customer_table_create, event_table_create, fact_table_table_create]
drop_table_queries = [fact_table_table_drop, customer_table_drop, user_table_drop, event_table_drop]
